...
describe(
    ...
    it => {
                ...
                packages: [
                    {
                        dir: resolve(
                            __dirname,
                            'fixtures/modules/simple-hello-module',
                        ),
                        // eslint-disable-next-line global-require, import/no-dynamic-require
                        ...require(resolve(
                            __dirname,
                            'fixtures/modules/simple-hello-module/package.json',
                        )),
                    },
                ],
            }).then(result =>
        ...
        it('should return a passing check for a package with a defined main app.js', assert =>
            checkPackages({
                packages: [
                    {
                        dir: resolve(
                            __dirname,
                            'fixtures/modules/simple-hello-module-main',
                        ),
                        // eslint-disable-next-line global-require, import/no-dynamic-require
                        ...require(resolve(
                            __dirname,
                            'fixtures/modules/simple-hello-module-main/package.json',
                        )),
                    },
                ],
            }).then(result =>
