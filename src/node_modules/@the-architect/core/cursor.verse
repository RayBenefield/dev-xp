...
architect_cursor_device<public> := class(tableau_device):
    ...
    GetResources<override>():[]resource= array:
        resource:
            ...
            Props := map:
                ...
                "Stackable" => Bool of Path(Path("Column ID"), "Stackable")
    ...
    GetSideEffects<override>(State:scoped_state)<suspends>:[]side_effect= array:
        PushStr("Block Type", SetMesh(CursorProp, BlockMeshes).FN)
        PushStr("Placeable", SetMaterial(CursorProp, IsPlaceableMaterials).FN)
