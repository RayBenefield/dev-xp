        ...
        resource:
            ...
            Actions := map:
                ...
                "Create Column" => Action of array:
                    ...
                    Execute(Path("Column ID"), "Add Block")
                "Alt Action" => Action of Execute(Path("Current Selector"), "Next")
                "Util Action" => Action of Execute("Type Selector", "Next")
                "Move Right" => Action of Execute(Path("Current Camera"), "Move Right")
                "Move Left" => Action of Execute(Path("Current Camera"), "Move Left")
                "Move Up" => Action of Execute(Path("Current Camera"), "Move Up")
                "Move Down" => Action of Execute(Path("Current Camera"), "Move Down")
                "Next Action" => Action of Execute("Camera Selector", "Next")
                "Prev Action" => Action of Execute("Camera Selector", "Previous")
