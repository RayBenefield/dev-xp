...
block_device<public> := class(creative_device, config_device, side_effect_device):
    ...
    GetSideEffects<override>(State:scoped_state)<suspends>:[]side_effect=
        ...
        PlaceBlock := SpawnProp(BlockMap[BlockType] or DefaultBlock, vector3{}, IdentityRotation())(0)
        SetLocation := set_location_fn. Prop := PlaceBlock
        array:
            PushVec3("Location", SetLocation.FN)
