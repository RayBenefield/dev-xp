...
return function(options)
    ...
    local function showFailure(t)
        ...
        print('# ' .. (t.element.trace.short_src or '') .. ' @ ' .. (t.element.trace.currentline or ''))
    ...
    function findSuite(context)
        local parent = busted.parent(context)
        return parent.descriptor == 'file' and context.name or findSuite(parent)
    end

    handler.testStart = function(element, parent)
        local suite = findSuite(element)
        ...
        if options.verbose and trace and trace.short_src then
            ...
            local testName = fileline .. fullName
            print('# ' .. testName)
        end
        io.flush()
    ...
    handler.testEnd = function(element, parent, status, trace)
        ...
        if status == 'success' then
            ...
            local name = string.gsub(t.name, findSuite(element) .. ' ', '')
            print(string_format(success, counter, name))
