    ...
    GetResources<override>():[]resource= array:
        ...
        resource:
            ...
            Props := map:
                ...
                "All Cards" => Strs of for(I:=1..8). "Hero Card{I}"
                "Available Cards" => Strs of (Path("All Cards"), "Reject", Path("Active"))
                "First Available Card" => Str of (Path("Available Cards"), "Get", ONE())
                "Active Cards" => Strs of (Path("All Cards"), "Filter", Path("Active"))
