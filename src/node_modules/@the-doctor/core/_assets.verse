...
ItemSetter<public><constructor>(Mat:M_Item_material)<transacts> := set_item_texture_fn. Mat := Mat
set_item_texture_fn<public> := class(texture_setter):
    Mat<public>:M_Item_material
    FN<override>(T:texture):void= set Mat.ItemTexture = T

CreateItemMaterialInstance()<transacts>:material_instance=
    Material := M_Item_material{}
    material_instance:
        Material := Material
        TextureSetterMap := map:
            "ItemTexture" => ItemSetter(Material)
        TextureMaps := map:
            "ItemTexture" => ItemTypes

AvatarSetter<public><constructor>(Mat:MI_HeroAvatar_material)<transacts> := set_avatar_texture_fn. Mat := Mat
set_avatar_texture_fn<public> := class():
    Mat<public>:MI_HeroAvatar_material
    FN<public>(T:texture):void= set Mat.AvatarTexture = T

<#>
    Asset Maps

DefaultTexture<public>:texture = SPR_HUD_FantasyWarrior_Icon_Tooltip01

ItemTypes<public>:[string]texture = map:
...
HeroTypes<public>:[string]texture = map:
    "femaledwarfbarb" => femaledwarfbarb
    "femaleelfbarb" => femaleelfbarb
    "femalehumanbarb" => femalehumanbarb
    "femaleorcbarb" => femaleorcbarb
    "maledwarfbarb" => maledwarfbarb
    "maleelfbarb" => maleelfbarb
    "malehumanbarb" => malehumanbarb
    "maleorcbarb" => maleorcbarb
    "femaledwarfbarb" => femaledwarfbarb
    "femaledwarfcleric" => femaledwarfcleric
    "femaledwarfranger" => femaledwarfranger
    "femaledwarfrogue" => femaledwarfrogue
    "femaledwarfwizard" => femaledwarfwizard
    "femaleelfbarb" => femaleelfbarb
    "femaleelfcleric" => femaleelfcleric
    "femaleelfranger" => femaleelfranger
    "femaleelfrogue" => femaleelfrogue
    "femaleelfwizard" => femaleelfwizard
    "femalehumanbarb" => femalehumanbarb
    "femalehumancleric" => femalehumancleric
    "femalehumanranger" => femalehumanranger
    "femalehumanrogue" => femalehumanrogue
    "femalehumanwizard" => femalehumanwizard
    "femaleorcbarb" => femaleorcbarb
    "femaleorccleric" => femaleorccleric
    "femaleorcranger" => femaleorcranger
    "femaleorcrogue" => femaleorcrogue
    "femaleorcwizard" => femaleorcwizard
    "maledwarfbarb" => maledwarfbarb
    "maledwarfcleric" => maledwarfcleric
    "maledwarfranger" => maledwarfranger
    "maledwarfrogue" => maledwarfrogue
    "maledwarfwizard" => maledwarfwizard
    "maleelfbarb" => maleelfbarb
    "maleelfcleric" => maleelfcleric
    "maleelfranger" => maleelfranger
    "maleelfrogue" => maleelfrogue
    "maleelfwizard" => maleelfwizard
    "malehumanbarb" => malehumanbarb
    "malehumancleric" => malehumancleric
    "malehumanranger" => malehumanranger
    "malehumanrogue" => malehumanrogue
    "malehumanwizard" => malehumanwizard
    "maleorcbarb" => maleorcbarb
    "maleorccleric" => maleorccleric
    "maleorcranger" => maleorcranger
    "maleorcrogue" => maleorcrogue
    "maleorcwizard" => maleorcwizard
