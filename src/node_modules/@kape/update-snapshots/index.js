...
import prettyPrint from 'jsome';
import readline from 'readline';
import sortBy from 'lodash.sortby';
import attempt from 'promise-retry';
import transmute from 'transmutation';
import promisify from 'es6-promisify';
import { cyan, red, white, green } from 'chalk';
...
const prompt = msg =>
    new Promise(res => rl.question(msg, answer => res(answer)));
...
export default ({ suiteFile, snapshotDir, testedResults }) =>
    transmute({
        suiteFile,
        testedResults,
        snapshotDir,
