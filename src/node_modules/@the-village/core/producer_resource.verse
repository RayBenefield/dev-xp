...
producer_settings<public> := class<concrete>():
    ...
    @editable LifetimeProduceResource:string = ""
...
CreateProducerResource<public><constructor>(ID:string, P:producer_settings) := resource:
    ...
    Props := map:
        ...
        "Show" => Bool of (Path("Exists"), "OR", Path("Could Have Afforded"))
        ...
        "Could Have Afforded" => Bool of (Path(P.LifetimeProduceResource, "Count"), ">=", Path("Cost"))
    ...
    Actions := map:
        ...
        "Produce" => Action of array:
            ...
            Increase(P.LifetimeProduceResource, "Count").By("Production Amount")
