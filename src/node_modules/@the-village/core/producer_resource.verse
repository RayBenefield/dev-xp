...
CreateProducerResource<public><constructor>(P:producer_settings) := resource:
    ...
    Props := map:
        ...
        "Has One" => prop_bool{ Focus := Path("Count"), FN := "=", Pay := load. Float := 1.0 }
        "Has Some" => prop_bool{ Focus := Path("Count"), FN := ">=", Pay := load. Float := 1.0 }
        "Has Workers" => prop_bool{ Focus := Path("Workers"), FN := ">=", Pay := load. Float := 1.0 }
        "No Workers" => prop_bool{ Focus := Path("Workers"), FN := "=", Pay := load. Float := 0.0 }
