...
producer_pos_hud_device<public> := class(creative_device, side_effect_device):
    ...
    GetSideEffects<override>(State:scoped_state)<suspends>:[]side_effect=
        ...
        array:
            PushMsg("Name", NameText.SetText)
            PushMsg("Cost", CostMsg, CostText.SetText)
            PushMsg("Count", CountMsg, CountText.SetText)
            PushMsg("Production Amount", ProdMsg, ProdText.SetText)
