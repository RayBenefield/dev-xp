...
export { mapIndexed, reduceIndexed } from 'ramda-adjunct'
export const suffix = R.flip(R.concat)
export const toList = R.pipe(RA.list, RA.flattenDepth(1))
export const mapToLists = R.map(toList)
export const callForEach = (fn, obj, items) =>
    R.forEachObjIndexed(
        args => R.bind(obj[fn], obj)(...args),
        mapToLists(items)
    )

export const trimChars = R.curry((char, str) =>
    R.pipe(RA.trimCharsStart(char), RA.trimCharsEnd(char))(str)
)

export const surround = (other, str) => R.concat(other, suffix(other, str))

export { isBoolean, isTrue, isFalse } from 'ramda-adjunct'
export { isPlainObject as isObject } from 'ramda-adjunct'
export { list } from 'ramda-adjunct'
export { isFunction, isNumber, isString, isArray } from 'ramda-adjunct'

export { flattenDepth } from 'ramda-adjunct'
export { default as flattenObj } from '@dev-xp/flatten-object'
