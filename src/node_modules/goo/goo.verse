...
boolmap_goo<public> := class(goo([string]logic)):
    ...
    Set<override>(NewValue:[string]logic):void= VM.Set(NewValue)
...
vec2_goo<public> := class(goo(vector2)):
    ...
    Set<override>(NewValue:vector2):void= VM.Set(NewValue)
...
vec3_goo<public> := class(goo(vector3)):
    ...
    Set<override>(NewValue:vector3):void= VM.Set(NewValue)
