...
MapStrsLength<public>(First:half_path,FirstGetter:type{_(:half_path):goo([]string)}):goo(int)=
    Map(FirstGetter(First), StrsLength)

IntGTE(First:int, Second:int)<transacts>:logic= if (First >= Second). true else. false
CompIntGTE<public>(First:half_path,FirstGetter:type{_(:half_path):goo(int)},Second:half_path,SecondGetter:type{_(:half_path):goo(int)}):goo(logic)=
    Computed(FirstGetter(First), SecondGetter(Second), IntGTE)

IntLTE(First:int, Second:int)<transacts>:logic= if (First <= Second). true else. false
CompIntLTE<public>(First:half_path,FirstGetter:type{_(:half_path):goo(int)},Second:half_path,SecondGetter:type{_(:half_path):goo(int)}):goo(logic)=
    Computed(FirstGetter(First), SecondGetter(Second), IntLTE)

IntGT(First:int, Second:int)<transacts>:logic= if (First > Second). true else. false
CompIntGT<public>(First:half_path,FirstGetter:type{_(:half_path):goo(int)},Second:half_path,SecondGetter:type{_(:half_path):goo(int)}):goo(logic)=
    Computed(FirstGetter(First), SecondGetter(Second), IntGT)

IntLT(First:int, Second:int)<transacts>:logic= if (First < Second). true else. false
CompIntLT<public>(First:half_path,FirstGetter:type{_(:half_path):goo(int)},Second:half_path,SecondGetter:type{_(:half_path):goo(int)}):goo(logic)=
    Computed(FirstGetter(First), SecondGetter(Second), IntLT)
...
CompStrEquals<public>(First:half_path,FirstGetter:type{_(:half_path):goo(string)},Second:half_path,SecondGetter:type{_(:half_path):goo(string)}):goo(logic)=
    Computed(FirstGetter(First), SecondGetter(Second), StrEquals)
...
CompVec3Add<public>(First:half_path,FirstGetter:type{_(:half_path):goo(vector3)},Second:half_path,SecondGetter:type{_(:half_path):goo(vector3)}):goo(vector3)=
    Computed(FirstGetter(First), SecondGetter(Second), Vec3Add)
...
GetStrFromStrs(Strs:[]string, Index:int)<transacts>:string= Strs[Index-1] or ""
CompGetStr<public>(First:half_path,FirstGetter:type{_(:half_path):goo([]string)},Second:half_path,SecondGetter:type{_(:half_path):goo(int)}):goo(string)=
    Computed(FirstGetter(First), SecondGetter(Second), GetStrFromStrs)

RandStrFromStrs(Strs:[]string)<transacts>:string= Strs[GetRandomInt(0, Strs.Length-1)] or ""
MapRandStr<public>(First:half_path,FirstGetter:type{_(:half_path):goo([]string)}):goo(string)=
    Map(FirstGetter(First), RandStrFromStrs)

IfTrueStr(Bool:logic, IfTrue:string)<transacts>:string= if (Bool?). IfTrue else. ""
CompIfTrueStr<public>(First:half_path,FirstGetter:type{_(:half_path):goo(logic)},Second:half_path,SecondGetter:type{_(:half_path):goo(string)}):goo(string)=
    Computed(FirstGetter(First), SecondGetter(Second), IfTrueStr)
