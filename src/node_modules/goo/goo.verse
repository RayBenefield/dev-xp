...
CompGTE<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(num)},Second:half_path,SecondGetter:type{_(:half_path)<suspends>:goo(num)})<suspends>:goo(logic)=
...
CompNumEquals<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(num)},Second:half_path,SecondGetter:type{_(:half_path)<suspends>:goo(num)})<suspends>:goo(logic)=
...
CompAnd<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(logic)},Second:half_path,SecondGetter:type{_(:half_path)<suspends>:goo(logic)})<suspends>:goo(logic)=
...
CompOr<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(logic)},Second:half_path,SecondGetter:type{_(:half_path)<suspends>:goo(logic)})<suspends>:goo(logic)=
    Computed(FirstGetter(First), SecondGetter(Second), OrBools)

NotBools(Bool:logic)<transacts>:logic = if (Bool?). false else. true
MapNot<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(logic)})<suspends>:goo(logic)=
    Map(FirstGetter(First), NotBools)

NotEmpty(Str:string)<transacts>:logic = if (Str <> ""). true else. false
MapNotEmpty<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(string)})<suspends>:goo(logic)=
    Map(FirstGetter(First), NotEmpty)

NumMultiply(First:num, Second:num):num = First * Second
CompNumMultiply<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(num)},Second:half_path,SecondGetter:type{_(:half_path)<suspends>:goo(num)})<suspends>:goo(num)=
    Computed(FirstGetter(First), SecondGetter(Second), NumMultiply)

NumPower(First:num, Second:float):num = First.Pow(Second)
CompNumPower<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(num)},Second:half_path,SecondGetter:type{_(:half_path)<suspends>:goo(float)})<suspends>:goo(num)=
    Computed(FirstGetter(First), SecondGetter(Second), NumPower)

NumToFloat<public>(Num:num):float = Num.Value * Pow(10.0, Num.Exponent * 1.0)
MapNumToFloat<public>(First:goo(num))<suspends>:goo(float)= Map(First, NumToFloat)
MapNumToFloat<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(num)})<suspends>:goo(float)=
    Map(FirstGetter(First), NumToFloat)

AppendStrs(First:string, Second:string):string = "{First}{Second}"
CompAppendStrs<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(string)},Second:half_path,SecondGetter:type{_(:half_path)<suspends>:goo(string)})<suspends>:goo(string)=
    Computed(FirstGetter(First), SecondGetter(Second), AppendStrs)

AppendFloats(X:float, Y:float):vector2 = vector2{ X := X, Y := Y }
CompAppendFloats<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(float)},Second:half_path,SecondGetter:type{_(:half_path)<suspends>:goo(float)})<suspends>:goo(vector2)=
...
CompAppendVec2AndFloat<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(vector2)},Second:half_path,SecondGetter:type{_(:half_path)<suspends>:goo(float)})<suspends>:goo(vector3)=
...
CompFloatMultiply<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(float)},Second:half_path,SecondGetter:type{_(:half_path)<suspends>:goo(float)})<suspends>:goo(float)=
    Computed(FirstGetter(First), SecondGetter(Second), FloatMultiply)

FloatToInt(Float:float):int = Float.ToInt()
MapFloatToInt<public>(First:goo(float))<suspends>:goo(int)= Map(First, FloatToInt)
MapFloatToInt<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(float)})<suspends>:goo(int)=
    Map(FirstGetter(First), FloatToInt)

FloatToNum(Float:float):num = num. Value := Float
MapFloatToNum<public>(First:goo(float))<suspends>:goo(num)= Map(First, FloatToNum)
MapFloatToNum<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(float)})<suspends>:goo(num)=
    Map(FirstGetter(First), FloatToNum)

IntAdd(First:int, Second:int)<transacts>:int = First + Second
CompIntAdd<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(int)},Second:half_path,SecondGetter:type{_(:half_path)<suspends>:goo(int)})<suspends>:goo(int)=
    Computed(FirstGetter(First), SecondGetter(Second), IntAdd)

IntToNum(Integer:int)<transacts>:num = num. Value := Integer*1.0
MapIntToNum<public>(First:goo(int))<suspends>:goo(num)= Map(First, IntToNum)
MapIntToNum<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(int)})<suspends>:goo(num)=
    Map(FirstGetter(First), IntToNum)

IntToFloat(Integer:int)<transacts>:float = Integer*1.0
MapIntToFloat<public>(First:goo(int))<suspends>:goo(float)= Map(First, IntToFloat)
MapIntToFloat<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(int)})<suspends>:goo(float)=
    Map(FirstGetter(First), IntToFloat)

BoolToStr(Value:logic):string = if (Value?). "true" else. "false"
MapBoolToStr<public>(First:goo(logic))<suspends>:goo(string)= Map(First, BoolToStr)
MapBoolToStr<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(logic)})<suspends>:goo(string)=
    Map(FirstGetter(First), BoolToStr)

NumToStr(Num:num):string = "{Num}"
MapNumToStr<public>(First:goo(num))<suspends>:goo(string)= Map(First, NumToStr)
MapNumToStr<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(num)})<suspends>:goo(string)=
    Map(FirstGetter(First), NumToStr)

FloatToStr(Float:float):string = "{Float}"
MapFloatToStr<public>(First:goo(float))<suspends>:goo(string)= Map(First, FloatToStr)
MapFloatToStr<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(float)})<suspends>:goo(string)=
    Map(FirstGetter(First), FloatToStr)

IntToStr(Integer:int):string = "{Integer}"
MapIntToStr<public>(First:goo(int))<suspends>:goo(string)= Map(First, IntToStr)
MapIntToStr<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(int)})<suspends>:goo(string)=
    Map(FirstGetter(First), IntToStr)

Vec2ToStr(Vec2:vector2):string = "{Vec2}"
MapVec2ToStr<public>(First:goo(vector2))<suspends>:goo(string)= Map(First, Vec2ToStr)
MapVec2ToStr<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(vector2)})<suspends>:goo(string)=
    MapVec2ToStr(FirstGetter(First))

Vec3ToStr(Vec3:vector3):string = "{Vec3}"
MapVec3ToStr<public>(First:goo(vector3))<suspends>:goo(string)= Map(First, Vec3ToStr)
MapVec3ToStr<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(vector3)})<suspends>:goo(string)=
    Map(FirstGetter(First), Vec3ToStr)

AgentToStr(Value:?agent):string = if (Value?). "[HAS AGENT]" else. "[NO AGENT]"
MapAgentToStr<public>(First:goo(?agent))<suspends>:goo(string)= Map(First, AgentToStr)
MapAgentToStr<public>(First:half_path,FirstGetter:type{_(:half_path)<suspends>:goo(?agent)})<suspends>:goo(string)=
