...
// Scopes for Viewer
// const twitchScopes = ['chat:read', 'chat:edit', 'user_read', 'user_follows_edit'].join('+')
const twitchScopes = [
    'chat:read',
    'chat:edit',
    'channel:moderate',
...
authRouter.get('/twitch', rampantAuth.authorize('twitch', twitchScopes))
authRouter.get('/twitter', rampantAuth.authorize('twitter'))
