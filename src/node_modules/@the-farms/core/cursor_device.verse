...
cursor_device<public> := class(creative_device, side_effect_device):
    ...
    GetSideEffects<override>(GameState:game_state, ResourceID:string, SubTypeID:string)<suspends>:[]side_effect=
        ...
        array:
            ...
            # Debug(Path("Can Plant"), "Farmer Can Plant")
            # Debug(Path("Can Water"), "Farmer Can Water")
            # Debug(Path("Can Harvest"), "Farmer Can Harvest")
            # Debug(Path("X"), "Farmer X")
            # Debug(Path("Y"), "Farmer Y")
            # Debug(Path("Location"), "Farmer Location")
