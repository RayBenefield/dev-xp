...
plot_device<public> := class(tableau_device):
    ...
    GetSideEffectSettings<override>()<transacts>:side_effect_settings= StaticTypeSideEffects()
    GetSideEffects<override>(State:scoped_state)<suspends>:[]side_effect=
        ...
        array:
            ...
            PushStr("Plant Stage", SetMesh(Plant, PlantMeshes).FN)
