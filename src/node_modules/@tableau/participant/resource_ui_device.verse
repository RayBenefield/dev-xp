...
resource_ui_device<public> := class(creative_device, updatable):
    ...
    # Messages
    Resources<localizes><private>(Count:string):message := "Resources: {Count}"
    ...
    Update<override>()<suspends>:void=
        ...
        then:
            TextBlock.SetText(Resources("{Participant.Resources}"))
            set CurrentState = option. ParticipantID
