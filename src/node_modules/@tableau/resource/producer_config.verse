...
CreateProducerResource<public><constructor>(Name:string, Production:float, ProductionRate:float, CostGrowth:float, BaseCost:float, CostResource:string, ProduceResource:string) := resource:
    ...
    Props := props:
        Nums := array:
            ...
            prop_num{ ID := "Produced Count", Default := num{} }
            prop_num{ ID := "Start Produced Count", Default := num{} }
        Floats := array:
    ...
    Abilities := array:
        ability:
            ...
            Effects := array:
                ...
                effect{ FN := "Decrease", Focus := Path(CostResource, "Count"), Pay := Load(Path("Cost")) }
        ...
        ability:
            ...
            Effects := array:
                ...
                effect{ FN := "Increase", Focus := Path(ProduceResource, "Count"), Pay := Load(Path("Production Amount")) }
