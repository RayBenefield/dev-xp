...
resource<public> := class<unique><concrete>():
    ...
    @editable StaticProperties<public>:[]property_str = array{}
    @editable Properties<public>:[]property_num = array{}
    @editable Abilities<public>:[]ability = array{}
    var PropertyValues<public>:[string][string]num = map{}

    SetProperty<public>(PropertyID:string, ParticipantID:string, Value:num)<decides><transacts>:resource=
        var NewValues:[string][string]num = Self.PropertyValues
