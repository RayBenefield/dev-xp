...
CopyResource<constructor>(Old:resource)<transacts> := resource:
    ...
    StatNums := Old.StatNums
    StatFloats := Old.StatFloats
    StatStrs := Old.StatStrs
    StatBools := Old.StatBools
...
resource<public> := class<unique><concrete>():
    ...
    var StatNums<public>:[string]num = map{}
    var StatFloats<public>:[string]float = map{}
    var StatStrs<public>:[string]string = map{}
    var StatBools<public>:[string]logic = map{}
    ...
    SetStatNumProperty<public>(PropertyID:string, Value:num)<decides><transacts>:resource=
        var NewValues:[string]num = Self.StatNums
        if (not NewValues[PropertyID]):
            if. set NewValues[PropertyID] = Value
        else:
            if. set NewValues[PropertyID] = Value
    ...
    SetStatFloatProperty<public>(PropertyID:string, Value:float)<decides><transacts>:resource=
        var NewValues:[string]float = Self.StatFloats
        if (not NewValues[PropertyID]):
            if. set NewValues[PropertyID] = Value
        else:
            if. set NewValues[PropertyID] = Value
        ...
        return resource:
            CopyResource<constructor>(Self)
            StatFloats := NewValues

    SetStatStrProperty<public>(PropertyID:string, Value:string)<decides><transacts>:resource=
        var NewValues:[string]string = Self.StatStrs
        if (not NewValues[PropertyID]):
            if. set NewValues[PropertyID] = Value
        else:
            if. set NewValues[PropertyID] = Value
    ...
    SetStatBoolProperty<public>(PropertyID:string, Value:logic)<decides><transacts>:resource=
        var NewValues:[string]logic = Self.StatBools
        if (not NewValues[PropertyID]):
            if. set NewValues[PropertyID] = Value
        else:
            if. set NewValues[PropertyID] = Value
