...
resource_repository<public> := class<concrete>():
    ...
    Add<public>(Resource:resource)<decides><transacts>:void=
        ...
        for (P:Resource.StatProps.Floats). if. set PropTypes[Resource.ID][P.ID] = prop_type.StatFloat
        for (P:Resource.StatProps.Nums). if. set PropTypes[Resource.ID][P.ID] = prop_type.StatNum
        for (P:Resource.StatProps.Strs). if. set PropTypes[Resource.ID][P.ID] = prop_type.StatStr
        for (P:Resource.StatProps.Bools). if. set PropTypes[Resource.ID][P.ID] = prop_type.StatBool
        for (P:Resource.StatProps.Agents). if. set PropTypes[Resource.ID][P.ID] = prop_type.StatAgent
        for (P:Resource.Props.Floats). if. set PropTypes[Resource.ID][P.ID] = prop_type.Float
        for (P:Resource.Props.Nums). if. set PropTypes[Resource.ID][P.ID] = prop_type.Num
        for (P:Resource.Props.Strs). if. set PropTypes[Resource.ID][P.ID] = prop_type.Str
        for (P:Resource.Props.Bools). if. set PropTypes[Resource.ID][P.ID] = prop_type.Bool
        for (P:Resource.Props.Agents). if. set PropTypes[Resource.ID][P.ID] = prop_type.Agent
