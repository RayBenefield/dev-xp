    ...
    Add<public>(Resource:resource)<decides><transacts>:void=
        ...
        for (ID->P:Resource.Props.Static):
            if. set PropTypes[Resource.ID][ID] = case(P.GetType()):
                ...
                prop_type.Vec2 => prop_type.StatVec2
                prop_type.Vec3 => prop_type.StatVec3
                prop_type.Agent => prop_type.StatAgent
                _ => P.GetType()
        for (ID->P:Resource.Props.Computed):
            if. set PropTypes[Resource.ID][ID] = case(P.GetType()):
                prop_type.Num => prop_type.CompNum
                prop_type.Float => prop_type.CompFloat
                prop_type.Str => prop_type.CompStr
                prop_type.Bool => prop_type.CompBool
                prop_type.Vec2 => prop_type.CompVec2
                prop_type.Vec3 => prop_type.CompVec3
                _ => P.GetType()
