...
NoAgent<public><constructor>()<transacts> := prop_agent{}
...
UEAgent<public><constructor>(Focus:prop_path)<transacts> := prop_agent. Focus := Focus.ToPath()
...
UEAgent<public><constructor>(Focus:prop_path, FN:string, Tweak:prop_path)<transacts> := prop_agent{ Focus := Focus.ToPath(), FN := FN, Tweak := Tweak.ToPath() }
MaybeUEAgent<public><constructor>(Focus:?prop_path)<transacts> := prop_agent. Focus := Focus?.ToPath() or EmptyPath()
