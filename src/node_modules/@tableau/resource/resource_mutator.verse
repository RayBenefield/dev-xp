...
resource_mutator<public> := class(mutator):
    ...
    UpdateProperty(Ev:domain_event)<suspends>:void=
        ...
        if:
            ...
            PropType := Resource.PropTypes[PropertyID]
        then:
            case(PropType):
                prop_type.Num =>
                    if:
                ...
                prop_type.Float =>
                    if:
                        ...
                        Value := PropFloats[ParticipantID]
                    then:
                        Property.ValueFor(ParticipantID).Set(Value)
                prop_type.Str =>
                    if:
                ...
                prop_type.Agent =>
                    if:
                        ...
                        Value := PropAgents[ParticipantID]
                    then:
                        Property.ValueFor(ParticipantID).Set(Value)
                _ => {}
