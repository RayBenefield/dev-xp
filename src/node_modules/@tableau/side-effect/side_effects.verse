...
TriggerActionOnTrue<public><constructor>(PropertySource:prop_path, ActionSource:prop_path)<transacts> := trigger_pipe{ PropertySource := Path(PropertySource), ActionSource := Path(ActionSource), TestValue := true }
TriggerActionOnFalse<public><constructor>(PropertySource:prop_path, ActionSource:prop_path)<transacts> := trigger_pipe{ PropertySource := Path(PropertySource), ActionSource := Path(ActionSource), TestValue := false }
