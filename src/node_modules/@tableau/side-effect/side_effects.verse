...
TriggerActionOnTrue<public><constructor>(PropertySource:prop_path, ActionSource:prop_path)<transacts> := true_trigger_pipe{ PropertySource := Path(PropertySource), ActionSource := Path(ActionSource), TestValue := true }
TriggerActionOnFalse<public><constructor>(PropertySource:prop_path, ActionSource:prop_path)<transacts> := false_trigger_pipe{ PropertySource := Path(PropertySource), ActionSource := Path(ActionSource), TestValue := false }
trigger_pipe<public> := class(attach_side_effect):
    PropertySource<public>:half_path
    ActionSource<public>:half_path
    TestValue<public>:logic
...
PushBool<public><constructor>(PropertyID:string, From:bool_map, To:bool_tap)<transacts> := bool_pipe{ PropertySource := Path(PropertyID), From := From, To := To }
...
PushBool<public><constructor>(PropertySource:prop_path, From:bool_map, To:bool_tap)<transacts> := bool_pipe{ PropertySource := Path(PropertySource), From := From, To := To }
bool_pipe<public> := class(bool_side_effect):
    PropertySource<public>:half_path
    To<public>:bool_tap
    From<public>:bool_map = Identity
    FN<override>(Value:logic)<suspends>:void= To(From(Value))
...
PushInt<public><constructor>(PropertyID:string, To:int_tap)<transacts> := int_pipe{ PropertySource := Path(PropertyID), To := To }
PushInt<public><constructor>(PropertyID:string, From:int_map, To:int_tap)<transacts> := int_pipe{ PropertySource := Path(PropertyID), From := From, To := To }
PushInt<public><constructor>(PropertySource:prop_path, To:int_tap)<transacts> := int_pipe{ PropertySource := Path(PropertySource), To := To }
PushInt<public><constructor>(PropertySource:prop_path, From:int_map, To:int_tap)<transacts> := int_pipe{ PropertySource := Path(PropertySource), From := From, To := To }
int_pipe<public> := class(int_side_effect):
    PropertySource<public>:half_path
    To<public>:int_tap
    From<public>:int_map = Identity
    FN<override>(Value:int)<suspends>:void= To(From(Value))

PushAgent<public><constructor>(PropertyID:string, To:agent_tap)<transacts> := agent_pipe{ PropertySource := Path(PropertyID), To := To }
PushAgent<public><constructor>(PropertySource:prop_path, To:agent_tap)<transacts> := agent_pipe{ PropertySource := Path(PropertySource), To := To }
...
debug_pipe<public> := class(str_side_effect):
    ...
    FN<override>(Value:string)<suspends>:void=
        FinalLabel := "[{Label?}]" or "{PropertySource.TryComplete(ResourceID?)?}" or "[{PropertySource.GetKey()}]"
