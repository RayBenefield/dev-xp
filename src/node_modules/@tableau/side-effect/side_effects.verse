...
TriggerAction<public><constructor>(PropertySource:prop_path, ActionSource:prop_path)<transacts> := trigger_pipe{ PropertySource := Path(PropertySource), ActionSource := Path(ActionSource) }
