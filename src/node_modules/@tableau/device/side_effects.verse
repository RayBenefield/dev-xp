...
anim_creator := type{_(:float):[]frame}
UpdateAnim<public><constructor>(Prop:?creative_prop, AnimCreator:anim_creator) := update_anim_fn{ Prop := Prop, AnimCreator := AnimCreator }
update_anim_fn<public> := class():
    Prop<public>:?creative_prop
    AnimCreator<public>:anim_creator
    FN<public>(Value:float):void= if (P := Prop?, A := P.GetAnimationController[]):
