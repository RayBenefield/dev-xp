...
StartWith<public><constructor>(To:tap) := first_pipe. To := To
...
PushStr<public><constructor>(PropertyID:string, From:str_map, To:str_tap) := str_pipe{ PropertyID := PropertyID, From := From, To := To }
...
PushFloat<public><constructor>(PropertyID:string, From:float_map, To:float_tap) := float_pipe{ PropertyID := PropertyID, From := From, To := To }
...
PushVec3<public><constructor>(PropertyID:string, From:vec3_map, To:vec3_tap) := vec3_pipe{ PropertyID := PropertyID, From := From, To := To }
...
PushMsg<public><constructor>(PropertyID:string, To:msg_tap) := msg_pipe{ PropertyID := PropertyID, To := To }
PushMsg<public><constructor>(PropertyID:string, From:str_map, To:msg_tap) := msg_pipe{ PropertyID := PropertyID, To := To, From := From }
