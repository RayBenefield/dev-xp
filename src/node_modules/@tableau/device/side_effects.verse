...
tap_side_effect<public> := interface(side_effect). FN<public>():void
bool_side_effect<public> := interface(side_effect). FN<public>(Value:logic):void
int_side_effect<public> := interface(side_effect). FN<public>(Value:int):void
...
toggle_prop<public> := class(bool_side_effect):
    ...
    FN<override>(Value:logic):void= if (P := Prop?):
...
toggle_animation<public> := class(bool_side_effect):
    ...
    FN<override>(Value:logic):void= if (P := Prop?, A := P.GetAnimationController[]):
...
set_mesh<public> := class(int_side_effect):
    ...
    FN<override>(Value:int):void= if (P := Prop?):
...
play_animation<public> := class(tap_side_effect):
    ...
    FN<override>():void= if (P := Prop?, A := P.GetAnimationController[]):
        A.Play()
