...
grid_device_v0_1<public> := class(tableau_device):
    ...
    @editable Index<public>:int_plug = int_plug{}
    ...
    GetResources<override>():[]resource= array. resource:
        Props := map:
            ...
            "Zero Base" => Integer of (Path("Index"), "-", ONE())
            "Value X" => Integer of (Path("Zero Base"), "Mod", Path("Max X"))
            "Value Y" => Integer of (Path("Zero Base"), "Quotient", Path("Max Y"))
            "X" => Integer of X
