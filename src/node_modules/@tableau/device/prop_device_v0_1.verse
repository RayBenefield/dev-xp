...
prop_device_v0_1<public> := class(tableau_device):
    ...
    GetSideEffects<override>(State:scoped_state)<suspends>:[]side_effect=
        ...
        FilterOptions of array:
            ...
            option. PushStr(Material1ID?, SetMaterial(P, Material1Map, 0).FN)
            option. PushStr(Material2ID?, SetMaterial(P, Material2Map, 1).FN)
            option. PushStr(Material3ID?, SetMaterial(P, Material3Map, 2).FN)
