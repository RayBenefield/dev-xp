        ...
        resource:
            ...
            Abilities := map:
                "Harvest" => ability. Effects := array:
                    effect{ FN := "Increase", Focus := Path("Wood", "Count"), Tweak := Path("ONE") }
        resource:
            ID := "Basic Tree"
            Props := map:
                "ONE" => prop_float. Default := 1.0
