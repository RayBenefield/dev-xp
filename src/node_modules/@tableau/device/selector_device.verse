...
CreateSelectorResource<public>(ResourceID:string, Items:[]string, Wrap:logic, IndexSource:?prop_path):resource=
    ...
    resource:
        ...
        Props := CreatedProps.CombineWithAll of map:
            ...
            "Current Index" => (Integer of IndexSource?) or (Integer of 1)
...
selector_device<public> := class(tableau_device):
    ...
    @editable IndexSource<public>:?prop_path = false

    GetResources<override>():[]resource= array. CreateSelectorResource(ResourceID, Items, Wrap, IndexSource)