...
CreateSelectorResource<public><constructor>(ResourceID:string, Items:[]string) := resource:
    ...
    Props := map:
        ...
        "Previous Index" => prop_int{ Focus := Path("Next Index"), FN := "+", Tweak := Path("-ONE") }
        ...
        "Is First Type" => prop_bool{ Focus := Path("Next Index"), FN := "Int <", Tweak := Path("ONE") }
    Abilities := map:
        "Next" => ability. Effects := array:
            Set("Next Index").To("New Index")
            IsTrue("Is Last Type")
            Set("Next Index").To("ONE")
        "Previous" => ability. Effects := array:
            Set("Next Index").To("Previous Index")
            IsTrue("Is First Type")
