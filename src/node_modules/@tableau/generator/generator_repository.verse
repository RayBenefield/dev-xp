generator_repository<public> := class<concrete>():
    ...
    GetOwnedGenerators<public>(OwnerID:int):[]generator=
        for (Generator:Keyed, Generator.OwnerID = OwnerID). Generator

    GetOwnedCountedGenerators<public>(OwnerID:int)<transacts>:[]generator=
        for:
            Generator:Keyed
            Generator.OwnerID = OwnerID
            Generator.GetCount(OwnerID) > 0
        do:
            Generator
