...
generator<public> := class<concrete>():
    ...
    ShouldBeVisible<public>(ParticipantID:int)<decides><transacts>:void=
        GetCount(ParticipantID) > 0

    ShouldShowNow<public>(OldGen:generator, ParticipantID:int)<decides><transacts>:void=
        OldGen.GetCount(ParticipantID) <= 0
        GetCount(ParticipantID) > 0

    ShouldHideNow<public>(OldGen:generator, ParticipantID:int)<decides><transacts>:void=
        OldGen.GetCount(ParticipantID) > 0
        GetCount(ParticipantID) <= 0
