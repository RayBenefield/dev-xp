...
producer_service_test := class(creative_device, test_suite):
    ...
    SimpleBuy():?failure =
        ...
        Service := producer_service{ Repo := Repo, ParticipantRepo := ParticipantRepo, EffectorProvider := effector_provider{} }
        Ev1 := Ev_ProducerPurchased(13, 26)
    ...
    BuyWithRequiredAndNoCost():?failure =
        ...
        ParticipantRepo := participant_repository. Initial := array. Participant
        Service := producer_service{ Repo := Repo, ParticipantRepo := ParticipantRepo, EffectorProvider := effector_provider{} }
        Ev1 := Ev_ProducerPurchased(14, 26)
