...
(Ints:[string]int).IntMapToStringMap<public>()<transacts>:[string]string= CreateMap of for(K->V:Ints). (K, "{V}")
...
(Value:string).RemoveSpaces<public>()<transacts>:string= for(C:Value, C <> ' '). C
