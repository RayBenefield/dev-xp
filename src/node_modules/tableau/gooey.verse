...
property_str<public> := class<concrete>(property(string)):
    ...
    ToVM<override>():gooey_string=
        Property := property(string):
            ID := ID
            Default := Default
        gooey_string. VM := Property.ToVM()

property_num<public> := class<concrete>(property(num)):
    @editable ID<override>:string = ""
    @editable Default<override>:num = num{}

    ToVM<override>():gooey_num=
        Property := property(num):
            ID := ID
            Default := Default
        gooey_num. VM := Property.ToVM()
