...
game_factory_device := class(creative_device):
    ...
    OnBegin<override>()<suspends>:void=
        ...
        EffectorProvider.Register(effector_type.AddResources, GrantResourcesEffector)
        EffectorProvider.Register(effector_type.BuyProducer, BuyProducerEffector)
        EffectorProvider.Register(effector_type.Produce, ProduceEffector)
