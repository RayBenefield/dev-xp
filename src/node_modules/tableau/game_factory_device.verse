...
game_factory_device := class(creative_device):
    ...
    OnBegin<override>()<suspends>:void=
        ...
        EffectorProvider.Register("Add Resources", GrantResourcesEffector)
        EffectorProvider.Register("Buy Producer", BuyProducerEffector)
        EffectorProvider.Register("Produce", ProduceEffector)
