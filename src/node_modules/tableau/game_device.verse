...
game_device := class(creative_device):
    ...
    OnBegin<override>()<suspends>:void=
        ...
        spawn. PseudoController(Dispatcher, ProducerRepository, BuyEffector)
    ...
    PseudoController(Dispatcher:dispatcher, Repo:producer_repository, BuyEffector:buy_producer_effector)<suspends>:void=
        loop:
