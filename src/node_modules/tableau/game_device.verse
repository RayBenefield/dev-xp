...
game_device := class(creative_device):
    ...
    OnBegin<override>()<suspends>:void=
            ...
            Initial := array:
                resource:
                    ...
                    StaticProperties := array:
                        property_str{ ID := "Name", Default := "Gold" }
                    Properties := array:
                ...
                resource:
                    ...
                    Name := "Producer"
                    StaticProperties := array:
                        property_str{ ID := "Name", Default := "Producer" }
        ...
        sync:
            ...
            Dispatcher.Dispatch(Ev_ResourceAdded("producer"))
    ...
    ProduceResources(GameState:game_state)<suspends>:void=
        ...
        loop:
            Sleep(1.0)
            if (Produce := GameState.Resources["producer"].Abilities["Produce"]):
