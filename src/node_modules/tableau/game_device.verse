...
CreateBasicResource<public><constructor>(Name:string) := resource:
    ...
    Abilities := array:
        ability:
            ID := "Increase Count"
            Effects := array:
                effect{ Type := "Increase", Pay := load. Str := "Count" }
                effect{ Type := "Set Property", Pay := load. Str := "Count" }
...
CreateProducerResource<public><constructor>(Name:string) := resource:
    ...
    CompProps := comp_props:
        Nums := array:
            comp_num:
                ...
                BaseProp := "Count"
                Transformers := array:
                    transformer{ Type := "Multiply", Pay := load. Str := "Production" }
            comp_num:
                ID := "Cost"
                BaseProp := "Count"
                Transformers := array:
                    transformer{ Type := "Reverse Power", Pay := load. Str := "Cost Growth" }
                    transformer{ Type := "Multiply", Pay := load. Str := "Base Cost" }
        # Bools := array:
        #     comp_bool:
        #         ID := "Can Afford"
        #         BaseResource := "Gold"
        #         BaseProp := "Count"
        #         Transformer := transformer{ Type := ">=", Pay := load. Str := "Cost" }
    Abilities := array:
        ability:
            ID := "Buy"
            Effects := array:
                effect{ Type := "Get Property", Pay := load. Str := "Count" }
                effect{ Type := "Increase", Pay := load. Float := 1.0 }
                effect{ Type := "Set Property", Pay := load. Str := "Count" }
    ...
    #             effector{ FN := "Pay Cost" }
        ability:
            ID := "Produce"
            Effects := array:
                effect{ Type := "Get Property", Pay := load. Str := "Production Amount" }
                effect{ Type := "Change Subject", Pay := load. Str := "Gold" }
                effect{ Type := "Execute Ability", Pay := load. Str := "Increase Count" }
    # Triggers := array:
