        ...
        if (Resource:= Repo.GetByID[ResourceID]):
            ...
            case(PropType):
                prop_type.Bool =>
                    ...
                    if (NewResource := Resource.SetBoolProperty[PropertyID, ParticipantID, Value]):
                ...
                prop_type.Num =>
                    ...
                    if (NewResource := Resource.SetNumProperty[PropertyID, ParticipantID, Value]):
                        if (Repo.Update[NewResource]). Dispatcher.Dispatch(Ev_PropertyUpdated(ResourceID, PropertyID, ParticipantID))
                _ => {}
