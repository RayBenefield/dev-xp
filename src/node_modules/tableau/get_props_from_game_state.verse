...
(GameState:game_state).GetNumProp<public>(ResourceID:string, PropertyID:string, PlayerID:string):num_goo =
    if (GSResource := GameState.Resources[ResourceID]):
        ...
        return case(PropType):
            prop_type.Num =>
                if (Num := GSResource.Props.Nums[PropertyID]). Num.ValueFor(PlayerID)
                else. NumGoo()
            prop_type.Float =>
                if (Float := GSResource.Props.Floats[PropertyID]). NumGoo(Map(Float.ValueFor(PlayerID), ToNum))
                else. NumGoo()
            prop_type.StatNum =>
                if (Num := GSResource.StatProps.Nums[PropertyID]). Num
                else. NumGoo()
            prop_type.StatFloat =>
                if (Float := GSResource.StatProps.Floats[PropertyID]). NumGoo(Map(Float, ToNum))
                else. NumGoo()
            prop_type.CompNum =>
                if (Num := GSResource.CompProps.Nums[PropertyID]). Num.ValueFor(PlayerID)
                else. NumGoo()
            _ => NumGoo()
    return NumGoo()
...
(GameState:game_state).GetFloatProp<public>(ResourceID:string, PropertyID:string, PlayerID:string):float_goo =
    if (GSResource := GameState.Resources[ResourceID]):
        ...
        return case(PropType):
            prop_type.Float =>
                if (Float := GSResource.Props.Floats[PropertyID]). Float.ValueFor(PlayerID)
                else. FloatGoo()
            prop_type.StatFloat =>
                if (Float := GSResource.StatProps.Floats[PropertyID]). Float
                else. FloatGoo()
            prop_type.Num =>
                if (Num := GSResource.Props.Nums[PropertyID]). FloatGoo(Map(Num.ValueFor(PlayerID), ToFloat))
                else. FloatGoo()
            prop_type.StatNum =>
                if (Num := GSResource.StatProps.Nums[PropertyID]). FloatGoo(Map(Num, ToFloat))
                else. FloatGoo()
            _ => FloatGoo()
    return FloatGoo()
...
(GameState:game_state).GetBoolProp<public>(ResourceID:string, PropertyID:string, PlayerID:string):bool_goo =
    if (GSResource := GameState.Resources[ResourceID]):
        ...
        return case(PropType):
            prop_type.StatBool =>
                if (Bool := GSResource.StatProps.Bools[PropertyID]). Bool
                else. BoolGoo(false)
            prop_type.Bool =>
                if (Bool := GSResource.Props.Bools[PropertyID]). Bool.ValueFor(PlayerID)
                else. BoolGoo(false)
            prop_type.CompBool =>
                if (Bool := GSResource.CompProps.Bools[PropertyID]). Bool.ValueFor(PlayerID)
                else. BoolGoo(false)
            _ => BoolGoo(false)
...
(GameState:game_state).GetStrProp<public>(ResourceID:string, PropertyID:string, PlayerID:string):string_goo =
    if (GSResource := GameState.Resources[ResourceID]):
        ...
        return case(PropType):
            ...
            prop_type.StatBool =>
                if (Bool := GSResource.StatProps.Bools[PropertyID]). StrGoo(Map(Bool, BoolToStr))
                else. StrGoo("")
            prop_type.Bool =>
                if (Bool := GSResource.Props.Bools[PropertyID]). StrGoo(Map(Bool.ValueFor(PlayerID), BoolToStr))
                else. StrGoo("")
            prop_type.CompBool =>
                if (Bool := GSResource.CompProps.Bools[PropertyID]). StrGoo(Map(Bool.ValueFor(PlayerID), BoolToStr))
                else. StrGoo("")
            _ => StrGoo("")
    return StrGoo("")
...
(GameState:game_state).GetAgentProp<public>(ResourceID:string, PropertyID:string, PlayerID:string):agent_goo=
    if (GSResource := GameState.Resources[ResourceID]):
        ...
        return case(PropType):
            prop_type.Agent =>
                if (Agent := GSResource.Props.Agents[PropertyID]). Agent.ValueFor(PlayerID)
                else. AgentGoo(false)
            prop_type.StatAgent =>
                if (Agent := GSResource.StatProps.Agents[PropertyID]). Agent
                else. AgentGoo(false)
            _ => AgentGoo(false)
...
(GameState:game_state).GetVec2Prop<public>(ResourceID:string, PropertyID:string, PlayerID:string):vec2_goo=
    if (GSResource := GameState.Resources[ResourceID]):
        ...
        return case(PropType):
            prop_type.CompVec2 =>
                if (Vec2 := GSResource.CompProps.Vec2s[PropertyID]). Vec2.ValueFor(PlayerID)
                else. Vec2Goo()
            _ => Vec2Goo()
    return Vec2Goo()
...
(GameState:game_state).GetVec3Prop<public>(ResourceID:string, PropertyID:string, PlayerID:string):vec3_goo=
    if (GSResource := GameState.Resources[ResourceID]):
        ...
        return case(PropType):
            prop_type.CompVec3 =>
                if (Vec3 := GSResource.CompProps.Vec3s[PropertyID]). Vec3.ValueFor(PlayerID)
                else. Vec3Goo()
            _ => Vec3Goo()
    return Vec3Goo()
