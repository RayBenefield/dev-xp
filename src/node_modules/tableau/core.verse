...
prop_type<public> := enum{ Integer, Num, Str, Bool, Float, Agent, Vec2, Vec3, Unknown }
...
prop_bool<public> := class<concrete>(prop):
    ...
    ValueFor<public>(State:player_state):bool_goo= case(FN):
        ...
        _ =>  case(Type):
            _ => if (not Focus.Empty[]). State.ToBool(Focus) else. BoolGoo(Default)
...
prop_float<public> := class<concrete>(prop):
    ...
    ValueFor<public>(State:player_state):float_goo= case(FN):
        ...
        _ => case(Type):
            ...
            _ => if (not Focus.Empty[]). State.ToFloat(Focus) else. FloatGoo(Default)
...
prop_num<public> := class<concrete>(prop):
    ...
    ValueFor<public>(State:player_state):num_goo= case(FN):
        ...
        _ => case(Type):
            ...
            _ => if (not Focus.Empty[]). State.ToNum(Focus) else. NumGoo(Default)
...
prop_str<public> := class<concrete>(prop):
    ...
    ValueFor<public>(State:player_state):string_goo= case(FN):
        ...
        _ => case(Type):
            ...
            _ => if (not Focus.Empty[]). State.ToStr(Focus) else. StrGoo(Default)
...
prop_agent<public> := class<concrete>(prop):
    ...
    ValueFor<public>(State:player_state):agent_goo= case(FN):
        _ => case(Type):
            _ => if (not Focus.Empty[]). State.ToAgent(Focus) else. AgentGoo(Default)
...
prop_vec2<public> := class<concrete>(prop):
    ...
    ValueFor<public>(State:player_state):vec2_goo= case(FN):
        "Append" => Vec2Goo(CompAppendFloats(Focus, State.ToFloat, Tweak, State.ToFloat))
        _ => case(Type):
            _ => if (not Focus.Empty[]). State.ToVec2(Focus) else. Vec2Goo(Default)
...
prop_vec3<public> := class<concrete>(prop):
    ...
    ValueFor<public>(State:player_state):vec3_goo= case(FN):
        "Append" => Vec3Goo(CompAppendVec2AndFloat(Focus, State.ToVec2, Tweak, State.ToFloat))
        _ => case(Type):
            _ => if (not Focus.Empty[]). State.ToVec3(Focus) else. Vec3Goo(Default)
