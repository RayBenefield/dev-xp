...
comp_vec2<public> := class<concrete>(prop):
    @editable ID<public>:string = ""
    @editable Focus<public>:half_path = half_path{}
    @editable FN<public>:string = ""
    @editable Pay<public>:load = load{}
...
comp_vec3<public> := class<concrete>(prop):
    @editable ID<public>:string = ""
    @editable Focus<public>:half_path = half_path{}
    @editable FN<public>:string = ""
    @editable Pay<public>:load = load{}
...
comp_agent<public> := class<concrete>(prop):
    @editable ID<public>:string = ""
    @editable Focus<public>:half_path = half_path{}
    @editable FN<public>:string = ""
    @editable Pay<public>:load = load{}
...
ToString<public>(Type:prop_type):string = case(Type):
    ...
    prop_type.CompVec2 => "CompVec2"
    prop_type.CompVec3 => "CompVec3"
    prop_type.CompAgent => "CompAgent"
