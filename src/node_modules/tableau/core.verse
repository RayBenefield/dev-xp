...
oldeffector<public> := interface():
    Play<public>(Command:command, Pay:load)<suspends>:?command
...
comp_float<public> := class<concrete>():
    @editable ID<public>:string = ""
    @editable BaseProp<public>:string = ""
    @editable BaseResource<public>:string = ""
    @editable Computer<public>:computer = computer{}

comp_num<public> := class<concrete>():
    @editable ID<public>:string = ""
    @editable BaseProp<public>:string = ""
    @editable BaseResource<public>:string = ""
    @editable Computer<public>:computer = computer{}

comp_str<public> := class<concrete>():
    @editable ID<public>:string = ""
    @editable BaseProp<public>:string = ""
    @editable BaseResource<public>:string = ""
    @editable Computer<public>:computer = computer{}

comp_bool<public> := class<concrete>():
    @editable ID<public>:string = ""
    @editable BaseProp<public>:string = ""
    @editable BaseResource<public>:string = ""
    @editable Computer<public>:computer = computer{}
...
tap<public> := type{_():void}
float_tap<public> := type{_(:float):void}
