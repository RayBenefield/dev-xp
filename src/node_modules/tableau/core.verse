...
prop_int<public> := class<concrete>(prop):
    ...
    ValueFor<public>(State:scoped_state):int_goo= case(FN):
        ...
        _ => case(Type):
            prop_type.Float => IntGoo(Map(State.ToFloat(Focus), FloatToInt))
...
prop_float<public> := class<concrete>(prop):
    ...
    ValueFor<public>(State:scoped_state):float_goo= case(FN):
        ...
        _ => case(Type):
            prop_type.Num => FloatGoo(Map(State.ToNum(Focus), NumToFloat))
            prop_type.Integer => FloatGoo(Map(State.ToInt(Focus), IntToFloat))
...
prop_num<public> := class<concrete>(prop):
    ...
    ValueFor<public>(State:scoped_state):num_goo= case(FN):
        ...
        _ => case(Type):
            prop_type.Float => NumGoo(Map(State.ToFloat(Focus), FloatToNum))
            prop_type.Integer => NumGoo(Map(State.ToInt(Focus), IntToNum))
...
prop_str<public> := class<concrete>(prop):
    ...
    ValueFor<public>(State:scoped_state):string_goo= case(FN):
        ...
        _ => case(Type):
            prop_type.Bool => StrGoo(Map(State.ToBool(Focus), BoolToStr))
            prop_type.Agent => StrGoo(Map(State.ToAgent(Focus), AgentToStr))
            prop_type.Integer => StrGoo(Map(State.ToInt(Focus), IntToStr))
            prop_type.Float => StrGoo(Map(State.ToFloat(Focus), FloatToStr))
            prop_type.Num => StrGoo(Map(State.ToNum(Focus), NumToStr))
            prop_type.Vec2 => StrGoo(Map(State.ToVec2(Focus), Vec2ToStr))
            prop_type.Vec3 => StrGoo(Map(State.ToVec3(Focus), Vec3ToStr))
