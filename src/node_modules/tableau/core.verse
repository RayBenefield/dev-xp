...
num_transformer_provider<public> := class():
    ...
    Register<public>(FN:string, NumTransformer:num_transformer):void=
        if (set NumTransformers[FN] = NumTransformer) {}

    Get<public>(FN:string)<decides><transacts>:num_transformer = NumTransformers[FN]
