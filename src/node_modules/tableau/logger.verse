...
Warning<public>(Message:[]char)<transacts>:void=
    Logger := log{Channel := my_log_channel}
    Logger.Print(Message, ?Level := log_level.Warning)
...
LogCallStack<public>()<transacts>:void=
    Logger := log{Channel := my_log_channel}
    Logger.PrintCallStack(?Level := log_level.Normal)
