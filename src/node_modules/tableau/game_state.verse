...
game_state<public> := class():
    ...
    AddResource<public>(InitialResource:resource)<suspends>:?resource_vm=
        ...
        if (InitialResource.ID <> ""):
            ...
            VM := resource_vm{ Resource := InitialResource }
        ...
        return false
    CreateResource<public>(ID:string, Type:string)<suspends>:void=
    ...
    GetAbility<public>(ResourceID:string, PropertyID:string, PlayerID:string):event_goo=
        ...
        if (Resource := Resources[ResourceID]):
            ...
            HardResult := Resource.Resource.GetAbility(PropertyID).ActionFor(Scoped)
...
scoped_state<public> := class():
    ...
    ToType<public>(HP:half_path)<suspends>:prop_type= GameState.GetPropType(Source, HP, PlayerID)
    CreateResource<public>(ResourceID:string, Type:string)<suspends>:void= GameState.CreateResource(ResourceID, Type)
