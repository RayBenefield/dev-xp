...
scoped_state<public> := class():
    ...
    SetBool<public>(HP:half_path, Value:logic)<suspends>:void= GameState.GetBoolProp(ResolveHalfPath(HP), PlayerID).Set(Value)
    SetInt<public>(HP:half_path, Value:int)<suspends>:void= GameState.GetIntProp(ResolveHalfPath(HP), PlayerID).Set(Value)
    SetFloat<public>(HP:half_path, Value:float)<suspends>:void= GameState.GetFloatProp(ResolveHalfPath(HP), PlayerID).Set(Value)
    SetNum<public>(HP:half_path, Value:num)<suspends>:void= GameState.GetNumProp(ResolveHalfPath(HP), PlayerID).Set(Value)
    SetStr<public>(HP:half_path, Value:string)<suspends>:void= GameState.GetStrProp(ResolveHalfPath(HP), PlayerID).Set(Value)
    SetStrs<public>(HP:half_path, Value:[]string)<suspends>:void= GameState.GetStrsProp(ResolveHalfPath(HP), PlayerID).Set(Value)
    SetAgent<public>(HP:half_path, Value:?agent)<suspends>:void= GameState.GetAgentProp(ResolveHalfPath(HP), PlayerID).Set(Value)
    SetVec2<public>(HP:half_path, Value:vector2)<suspends>:void= GameState.GetVec2Prop(ResolveHalfPath(HP), PlayerID).Set(Value)
    SetVec3<public>(HP:half_path, Value:vector3)<suspends>:void= GameState.GetVec3Prop(ResolveHalfPath(HP), PlayerID).Set(Value)
    ...
    ExecuteAction<public>(HP:half_path)<suspends>:void=
        ...
        SubID := if(GameState.IsRelated[Source, ResourceID]). Source else. PlayerID
        GameState.GetAction(ResourceID, TargetPropertyID, SubID).Set()
