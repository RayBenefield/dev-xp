...
game_state<public> := class():
    ...
    AddResource<public>(Resource:resource):void=
        ...
        if (Resource.ID <> "" and (not Resources[Resource.ID])):
            ...
            FinalResource := if (Template := ResourceTemplates[Resource.Type]). MergeResources(ResourceWithID, Template) else. ResourceWithID
...
scoped_state<public> := class():
    ...
    AwaitStr<public>(ResourceID:string):str_goo= GameState.GetStrProp(ResourceID, PropertyID, PlayerID)
