...
@include array(number, #A2FD42)
@include circle(any, #FFFFFF)
@include array(any, #FFFFFF)
@include array(functor, #FFFFFF)
@include circle(boolean, #920000)
@include array(boolean, #920000)
@include square(function, #FD393B)
@include array(function, #FD393B)
