...
ScaleBy<public><constructor>(All:vector3)<transacts> := scale_by{ X := All.X, Y := All.Y, Z := All.Z }
...
MoveXTo<public><constructor>()<transacts> := move_to. X := option. 0.0
MoveXTo<public><constructor>(X:float)<transacts> := move_to. X := option. X
MoveYTo<public><constructor>()<transacts> := move_to. Y := option. 0.0
MoveYTo<public><constructor>(Y:float)<transacts> := move_to. Y := option. Y
MoveZTo<public><constructor>()<transacts> := move_to. Z := option. 0.0
