...
Surround<public>(Surrounding:string, Item:string)<computes>:string = "{Surrounding}{Item}{Surrounding}"
surrounder<public> := class():
    Surrounding<public>:string
    FN<public>(Item:string)<computes>:string = Surround(Surrounding, Item)

pairs<public> := enum{ Square, Curly, Parens, Angle }
Encompass<public>(Before:string, After:string, Item:string)<computes>:string = "{Before}{Item}{After}"
...
(Array:[]string).Join<public>()<computes>:string = Join(Array, "")
